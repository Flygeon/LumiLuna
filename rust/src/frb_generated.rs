...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1942300523;
...
fn wire__crate__api__media_scan__extract_audio_cover_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "extract_audio_cover",
            port: Some(port_),
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok(
                        crate::api::media_scan::extract_audio_cover(api_path, api_output_path),
                    )?;
                    Ok(output_ok)
                })())
            }
...
fn wire__crate__api__media_scan__extract_video_cover_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "extract_video_cover",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            let api_path = <String>::sse_decode(&mut deserializer);
            let api_output_path = <String>::sse_decode(&mut deserializer);
            let api_time_ms = <u32>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok =
                        Result::<_, ()>::Ok(crate::api::media_scan::extract_video_cover(
                            api_path,
                            api_output_path,
                            api_time_ms,
                        ))?;
...
fn wire__crate__api__media_scan__ping_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok(crate::api::media_scan::ping())?;
                    Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__media_scan__scan_media_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok =
                        Result::<_, ()>::Ok(crate::api::media_scan::stable_hash(api_path))?;
                    Ok(output_ok)
                })())
            }
        },
...
impl SseDecode for Vec<crate::api::media_scan::RustMediaItem> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut len_ = <i32>::sse_decode(deserializer);
        let mut ans_ = Vec::with_capacity(len_ as usize);
        for idx_ in 0..len_ {
            ans_.push(<crate::api::media_scan::RustMediaItem>::sse_decode(
                deserializer,
            ));
        }
        return ans_;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__media_scan__extract_audio_cover_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        2 => wire__crate__api__media_scan__extract_video_cover_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        4 => wire__crate__api__media_scan__ping_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__media_scan__scan_media_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__media_scan__scan_media_batch_impl(port, ptr, rust_vec_len, data_len),
        7 => {
            wire__crate__api__media_scan__scan_media_batches_impl(port, ptr, rust_vec_len, data_len)
        }
        8 => wire__crate__api__media_scan__stable_file_hash_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__media_scan__stable_hash_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
impl flutter_rust_bridge::IntoDart for crate::api::media_scan::RustMediaItem {
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::media_scan::RustMediaItem
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::media_scan::RustMediaItem>
    for crate::api::media_scan::RustMediaItem
{
    fn into_into_dart(self) -> crate::api::media_scan::RustMediaItem {
        self
    }
}
...
impl SseEncode for Vec<crate::api::media_scan::RustMediaItem> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(self.len() as _, serializer);
        for item in self {
            <crate::api::media_scan::RustMediaItem>::sse_encode(item, serializer);
        }
    }
}
